            ...
            <section class="blog section bd-container" id="blog">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/img/accessoire1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Blossoms</h3>
                        <span class="menu__detail">Read About the signification</span>
                        <span class="menu__preci">$400.00</span>
                        <a href="index2.html" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/accessoire2.png" alt="" class="menu__img">
                        <h3 class="menu__name">Sunshine</h3>
                        <span class="menu__detail">Read About the signification</span>
                        <span class="menu__preci">$240.00</span>
                        <a href="index2.html" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/img/accessoire3.png" alt="" class="menu__img">
                        <h3 class="menu__name">Summer</h3>
                        <span class="menu__detail">Read About the signification</span>
                        <span class="menu__preci">$900.50</span>
                        <a href="index2.html" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    <div class="menu__content">
                        <img src="assets/img/accessoire4.png" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="assets/img/accessoire5.png" alt="" class="menu__img">
